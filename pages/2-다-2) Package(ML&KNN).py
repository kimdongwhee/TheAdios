...
def main():
    ...
    # Load data
    FW_df = pd.read_csv('./useData/OOF/Scaled_ST_final.csv', index_col=0)
    MID_df = pd.read_csv('./useData/OOF/Scaled_MID_final.csv', index_col=0)
    DF_df = pd.read_csv('./useData/OOF/Scaled_DC_final.csv', index_col=0)
